...
docker cp .\midpoint-dist\doc\config\sql\native\postgres.sql dostup_claster_docker-postgres-1:/tmp/postgres.sql
docker cp .\midpoint-dist\doc\config\sql\native\postgres-audit.sql dostup_claster_docker-postgres-1:/tmp/postgres-audit.sql
docker cp .\midpoint-dist\doc\config\sql\native\postgres-quartz.sql dostup_claster_docker-postgres-1:/tmp/postgres-quartz.sql
